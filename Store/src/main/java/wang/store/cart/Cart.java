...
public class Cart implements Serializable{
	...
	private static final long serialVersionUID = -7986173967343992887L;
	...
	public Cart(Integer id, Integer userId, Integer productId, String productName, Integer productCategoryId,
			Integer productPrice, Integer productNumber, String productImage) {
		super();
		this.id = id;
		this.userId = userId;
	...
	public String toString() {
		return "Cart [id=" + id + ", userId=" + userId + ", productId=" + productId + ", productName=" + productName
				...
				+ productNumber + ", productImage=" + productImage + "]";
	}
