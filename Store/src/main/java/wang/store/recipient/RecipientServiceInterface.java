...
public interface RecipientServiceInterface {
	 ...
	 * @return 受影響的行數
	 */
	Integer add(Recipient recipient);
	 ...
	 * @return 收件人列表
	 */
	List<Recipient> findByUserId(Integer userId);
	 ...
	 * @return 符合的該項收件人資料
	 */
	Recipient findByUserIdAndId(@Param("userId") Integer userId, @Param("id") Integer id);
	 ...
	 * @return 受影響的行數
	 */
	Integer change(Recipient recipient);
